    ...
    def insert_question(self):
        ...
        if add:
            ...
            if self.modification == 0:
                columns = '("question", "correct", "explain", "section", "difficulty", "source", "inputuser", "inputdate")'
                insertstring = (f'INSERT INTO {table} {columns} VALUES ('
                                f'"{myfun.format_question_to_latex(self.input_question.toPlainText(), "判断题")}", '
                                f'{self.answer}, '
                                f'"{myfun.format_enter_to_latex(self.input_explain.toPlainText())}", '
                                f'{self.section_id}, '
                ...
                updatestring = (f'UPDATE {table} SET question="{myfun.format_question_to_latex(self.input_question.toPlainText(), "判断题")}", '
                                f'correct={self.answer}, '
                                f'explain="{myfun.format_enter_to_latex(self.input_explain.toPlainText())}", '
