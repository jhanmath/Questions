...
class AddMultipleChoice(QWidget):
    ...
    def update_preview(self):
        ...
        pageSourceContent = ('<p>' + myfun.format_question_to_html(self.input_question.toPlainText(), '多选题') + '</p>'
        ...
        pageSourceContent += ('<p>答案: ' + answer + '</p>'
    ...
    def insert_question(self):
        ...
        if add:
            ...
            if self.modification == 0:
                columns = '("question", "A", "B", "C", "D", "pos_A", "pos_B", "pos_C", "pos_D", "explain", "section", "difficulty", "source", "inputuser", "inputdate")'
                insertstring = (f'INSERT INTO {table} {columns} VALUES ('
                                f'"{myfun.format_question_to_latex(self.input_question.toPlainText(), "多选题")}", '
                                f'"{myfun.format_enter_to_latex(self.input_answerA.toPlainText())}", '
                                f'"{myfun.format_enter_to_latex(self.input_answerB.toPlainText())}", '
                                f'"{myfun.format_enter_to_latex(self.input_answerC.toPlainText())}", '
                                f'"{myfun.format_enter_to_latex(self.input_answerD.toPlainText())}", '
                                f'{self.pos[0]}, '
                                f'{self.pos[1]}, '
                                f'{self.pos[2]}, '
                                f'{self.pos[3]}, '
                ...
                updatestring = (f'UPDATE {table} SET question="{myfun.format_question_to_latex(self.input_question.toPlainText(), "多选题")}", '
